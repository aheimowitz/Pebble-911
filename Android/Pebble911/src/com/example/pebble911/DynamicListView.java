...
public class DynamicListView extends ListView {
     ...
     * @throws IOException 
     */
    private void handleCellSwitch() throws IOException {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(contactlist, originalItem, getPositionForView(switchView));
    ...
    private void swapElements(ArrayList arrayList, int indexOne, int indexTwo) throws IOException {
    ...
    public void setcontactlist(ArrayList<String> contactsin) {
        contactlist = contactsin;
    }
    ...
    private AbsListView.OnScrollListener mScrollListener = new AbsListView.OnScrollListener () {
         ...
         * @throws IOException 
         */
        public void checkAndHandleFirstVisibleCellChange() throws IOException {
         ...
         * @throws IOException 
         */
        public void checkAndHandleLastVisibleCellChange() throws IOException {
